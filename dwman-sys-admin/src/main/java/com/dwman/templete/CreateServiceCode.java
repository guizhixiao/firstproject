...
public class CreateServiceCode {
    public static void main(String[] args) throws Exception {
        CreateServiceCode createBizCode = new CreateServiceCode() ;
    ...
    public void createBizCode() throws Exception {
        ...
        templeteFileEntity.setTemplateFile(TempleteFileEntity.DEFAULT_SERVICE_TEMPLETE);
        templeteFileEntity.setDescFile("/Users/gaoya/apps/firstproject/dwman-sys-admin/src/main/java/com/dwman/service/DeptService.java");
